        ...
        <div className="mt-[138px] flex justify-center self-stretch">
            <div className="container-xs flex justify-center md:px-5">
                <div className="relative h-[500px] w-full bg-gray-900 px-14 md:px-5">
                    <div className="absolute bottom-0 right-[10%] top-0 my-auto h-[500px] w-[504px] rounded-[252px] bg-blue_gray-100_ 4c blur-[200.00px] backdrop-opacity-[0.5]" />
                            ...
                            <div className="self-stretch">
                                <div className="mr-[122px] flex gap-6 md:mr-0 md:flex-row sm:flex-col">
                                    <Suspense fallback={<div>Loading feed...</div>}>
                                        {[...Array(4)].map((d, index) => (
                                            <AccountDropdownWithAccountFlashsell key={"listfive" + index} ></AccountDropdownWithAccountFlashsell>
                                        ))}
                                    </Suspense>
                                </div>
                            </div>
                            <Button color="black_900_01" size="4xl" className="min-w-[170px] rounded px-[34px] font-medium sm:px-5">
                                Buy Now!
                            </Button>
                        </div>
                        <Img
