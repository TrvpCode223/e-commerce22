import { Button, Heading, Img, RatingBar, Slider } from "../../components";
import React from "react";

export default function EcommercehomeColumnOne() {
    const [sliderState, setSliderState] = React.useState(9);
        ...
        <div className="container-xs mt-[60px] md:px-5">
            <div className="flex flex-col gap-[78px] md:gap-[58px] sm:gap-[39px]">
                ...
                <div className="flex flex-col gap-[70px] md:gap-[52px] sm:gap-[35px]">
                    <div className="flex flex-col gap-[60px] sm:gap-[30px]">
                        ...
                        <div className="mb-2.5 flex gap-2 self-end">
                            <Button color="gray 100" size="3xl" className="w-[46px] rounded-[22px] px-2.5">
                ...
                <div className="mx-auto flex w-full overflow-x-scroll">
                    <Slider
autoPlay={false}  // Désactive l'auto-play
autoPlayInterval={2000}  // Peut être laissé pour le réglage initial, mais l'auto-play est désactivé
responsive={{ 0: { items: 1 }, 551: { items: 1 }, 1051: { items: 1 } }}
disableDotsControls={true}  // Désactive les points de contrôle
disableArrowControls={false}  // Assurez-vous que les flèches restent actives
                            ...
                            <React.Fragment key={Math.random()}>
                                <div className="flex gap-[30px] md:flex-col">
                                    <div className="container-xs flex gap-[30px] md:flex-col md:px-5">
                                                ...
                                                <div className="mt-3 flex flex-col gap-3.5">
                                                    <div className="relative mx-3 h-[182px] md:mx-0 md:h-auto">
                                                        ...
                                                        <div className="absolute left-0 right-0 top-0 mx-auto flex flex-1 flex-col items-end gap-2">
                                                            ...
                                                            <Button shape="round" className="w-[34px] rounded-[16px] px-1">
                                                                <Img src="images/img_quick view.svg" />
                                                            </Button>
                                                        </div>
                                        ...
                                        <div className="flex w-full flex-col gap-4">
                                            <div className="relative h-[250px] rounded bg-gray-100 p-3 md:h-auto">
                                                <Button color="orange 700" size="xs" className="min-w-[54px] rounded px-3">
                                                    -30%
                                                </Button>
                                                <div className="absolute left-0 right-0 top-3 mx-auto flex flex-1 flex-col items-end gap-2">
                                                    <Button shape="round" className="w-[34px] rounded-[16px] px-1">
                                        ...
                                        <div className="flex w-full flex-col gap-4">
                                            <div className="flex items-start justify-center rounded bg-gray-100 p-3">
                                                <Button color="orange 700" size="xs" className="min-w-[54px] rounded px-3">
                                                    -25%
                                                </Button>
                                                <Img
                                                    ...
                                                    alt="Sammoghadamkh"
                                                    className="my-[22px] ml-3.5 h-[180px] w-[46%] self-center object-contain"
                                                />
                                    ...
                                    <div className="flex w-[32%] flex-col gap-4 md:w-full md:px-5">
                                        <div className="flex gap-[30px] sm:flex-col">
                                            <div className="relative h-[250px] w-full rounded bg-gray-100 p-3 md:h-auto sm:w-full">
                                                <Button color="orange 700" size="xs" className="min-w-[54px] rounded px-3">
                                                    -25%
                                                </Button>
                                                <div className="absolute left-0 right-0 top-3 mx-auto flex flex-1 flex-col items-end gap-2">
                                        ...
                                        <div className="flex sm:flex-col">
                                            ...
                                            <div className="flex w-full flex-col items-start gap-2 sm:w-full">
                                                ...
                                                <div className="flex gap-2 self-stretch">
                                                    <div className="flex">
                                                        <Img src="images/img_signal.svg" alt="Signal" className="h-[20px] rounded-[1px]" />
                                                        <Img src="images/img_signal.svg" alt="Signal" className="h-[20px] rounded-[1px]" />
                                                        <Img src="images/img_signal.svg" alt="Signal" className="h-[20px] rounded-[1px]" />
                                                        <Img src="images/img_signal.svg" alt="Signal Eleven" className="h-[20px] rounded-[1px]" />
                                                        <Img src="images/img_star_half_filled.svg" alt="Image" className="h-[200px]" />
                                                    </div>
                                                    <Heading size="headingxs" as="p" className="text-[14px] font-semibold !text-black-900_7f">
                                                        (99)
                                                    </Heading>
