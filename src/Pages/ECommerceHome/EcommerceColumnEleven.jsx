    ...
    return (
        <div className="mt-[70px] flex flex-col items-center self-stretch">
            <div className="container-xs flex flex-col items-center gap-[60px] md:px-5 sm:gap-[30px]">
                <div className="flex flex-col gap-[60px] self-streth sm:gap-[30px]">
                    <div className="flex items-center justify-between gap-5 md:flex-col">
                        <div className="flex flex-1 flex-col items-start gap-5 md:self-stretch">
                            <div className="flex items-center gap-4 self-stretch">
                                ...
                                <Heading size="heading" as="h6" className="text-[16px] font-semibold !text-orange-700">
                                    Our Products
                                </Heading>
                            </div>
                            <Heading
                        ...
                        <div className="flex gap-2 self-end">
                            ...
                            >
                                <Img src="images/img_arrow-left.svg" />
                            </Button>
                            <Button
                                onClick={() => {
                                ...
                                className="w-[46px] rounded-[22px] px-2.5"
                            >
                                <Img src="images/img_arrow-right_gray_900.svg" />
                            </Button>
                        </div>
                    </div>
                           ...
                           vonSlideChange={(e) => {
                            ...
                            items={[...Array(3)].map((_, index) => (
                                <React.Fragment key={Math.random()}>
                                    <div className="flex flex-col gap-[60px] sm:gap-[30]">
                                        <div className="flex gap-[30px] md:flex-col">
                                            <div className="flex w-full flex-col gap-4">
                                                <div className="relative h-[250px] rounded bg-gray-100 p-3">
                                                    <div className="absolute left-0 rigth-0 top-3 mx-auto flex flex-col items-end gap-2">
                                                        <Button>
                                                    ...
                                                    <div className="absolute bottom left-0 right-0 top-0 m-auto flex h-max flex-1 px-14 md:px-5">
                                                        <Img
                                                ...
                                                <div className="flex flex-col items-start gap-2">
                                                    ...
                                                    <div className="flex items-center self-stretch">
                                                        ...
                                                        <div className="flex flex-1 items-center gap-2 px-2">
                                                            ...
                                                            />
                                                            <Heading size="headingxs" as="p" className="text-[14px] font-medium !text-black-900_7f">
                                                                (35)
                                                            </Heading>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="flex w-full flex-col gap-4">
                                                <div className="rounded bg-gray-100">
                                                    <div className="mt-3 flex items-start justify-end md:md-0">
                                                        <Img
                                                            src="images/img_eos_250d_03_500x500.png"
                                                            alt="Eos250dthree"
                                                            className="mt-2.5 h-[16px] w-[58%]self-end object-contain"
                                                        />
                                                        <div className="flrx flex-col items-end gap-2">
                                                            <Button shape="round" className="w-[34px] rounded-{16px] px-1">
                                                                <Img src="images/img_quick_view.svg" />
                                                            </Button>
                                                        </div>
                                                    ...
                                                    <Button
                                                        color="gray_900"
                                                        size="xl"
                                                        className="self-stretch rounded-bl rounded-br px[34px] font-medium sm:medium sm:px-5"
                                                    >
                                                        Ajouter au panier
                                                    </Button>
                                                </div>
                                            ...
                                            <div className="flex flex-col items-start gap-2">
                                                ...
                                                <div className="flex items-center self-stretch">
                                                    <Heading as="p" className="text-[16px] font-medium !text-orang">
                                                        $360
                                                    </Heading>
                                                    <div className="flex flex-1 items-center gap-2 px-2">
                                                        <RatingBar
                                                ...
                                                <div className="flex w-full flex-col gap 4">
                                                    <div className="flex items-start justify-end rounded bg-gray-100 p-3">
                                                        <Img
                                                            ...
                                                            alt="Ideapadgaming"
                                                            className="my-[22px] h-[180px] w-[70%] self-end object-contain"
                                                        />
                                                        <div className="flex flex-col items-end gap-2">
                                                            <Button shape="round" className="w-[34px] rounded-{16px] px-1">
                                                                <Img src="images/img_wishkist.svg" />
                                                            </Button>
                                                            <Button shape="round" className="w-[34px] rounded-{16px] px-1">
                                                                <Img src="images/img_quick_view.svg" />
                                                            </Button>
                                                ...
                                                <div className="flex w-full flex-col gap-4">
                                                    ...
                                                    <div className="flex flex-col items-start gap-2">
                                                        ...
                                                        <div className="flex items-center self-stretch">
                                                            <Heading as="p" className="text-[16px] font-medium !text-orang-700">
                                                                $500
                                                            </Heading>
                                                            <div className="flex flex-1 items-center gap-2 px-2">
                                                                <RatingBar
                                                ...
                                                <div className="flex gap-[30px] md:flex-col">
                                                    <div className="flex w-full flex-col gap-4">
                                                        <div className="elative h-[250] rounded bg-gray-100 p-3 md:h-auto">
                                                            ...
                                                            <div className="absolute bottom-0 left-0 rigth-0 top-0 m-auto flex h-max flex-1 p-[22px] sm:p-5">
                                                                <Img
                                                        ...
                                                        <div className="flex flex-col items-start gap-2">
                                                            ...
                                                            <div className="flex items-center self-stretch">
                                                                <Heading as="p" className="text-[14px] font-medium !text-orange-700">
                                                                    $960
                                                                </Heading>
                                                                <div className="flex flex-& items-center gap-2 px-2">
                                                                    <RatingBar
                                                                        value={5}
                                                                        isEditable={true}
                                                                        color="#00000071"
                                                                        ...
                                                                        className="flex gap-2.5"
                                                                    />
                                                                    <Heading size="headingxs" as="p" className="text-[14px] font-semibol !text-black-900_7f">
                                                                        (65)
                                                                    </Heading>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="flex w-full flex-col gap-4">
                                                        <div className="relative h-[250] rounded bg-gray-100 p-3">
                                                            <div className="absolute left-0 rigth-0 top-3 mx-auto flex flex-1 flex-col items-end gap-2">
                                                                <Button shape="round" className="w-[34px] rounded-[16px] px-1">
                                                                    <Img src="images/img_wishlist.svg" />
                                                                </Button>
                                                                <Button shape="round" className="w-[34px] rounded-[16px] px-1">
                                                        ...
                                                        <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank" rel="noreferrer">
                                                            <div className="flex w-full flex-col gap-4">
                                                                <div className="relative h-[250] rounded bg-gray-100 p-3 md:h-auto">
                                                                    ...
                                                                    <div className="flex items-center self-stretch">
                                                                        ...
                                                                        <div className="flex flex-1 items-center gap-2 px-2">
                                                                            ...
                                                                            <Heading
                                                                                size="headingxs"
                                                                                as="p"
                                                                                className="text-[14px] font-semibold !text-black-900_7f"
                                                                            >
                                                                                (55)
                                                                            </Heading>
                                                        ...
                                                        <div className="flex w-full flex-col gap-4">
                                                            <div className="relative h-[250px] rounded bg-gray-100 p-3">
                                                                ...
                                                                <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1">
                                                                    <Img
                                                                        src="images/img_698717_z8a1x.png"
                                                                        alt="698717z8a1xthir"
                                                            ...
                                                            <div className="flex flex-col items-start gap-2">
                                                                ...
                                                                <div className="flex items-center self-stretch">
                                                                    <Heading as="p" className="text-[14px] font-medium text-orang-700">
                                                                        $660
                                                                    </Heading>
                                                                    <div className="flex flex-1 items-center gap-2 px-2">
                                                                        <RatingBar
                                                                            ...
                                                                            className="flex gap-2.5"
                                                                        />
                                                                        <Heading size="headingxs" as="p" className="text-[14px] fonf-semibold !text-black-900_7f">
                                                                            (55)
                                                                        </Heading>
                                                                    </div>
                                                                </div>
                                                                <Img src="images/img_user_orange_700_20x48.svg" alt="User" className="h-[20px]" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
