...
<div className="absolute bottom-0 right-[10%] top-0 my-auto h-[500px] w-[504px] rounded-[252px] bg-blue_gray-100_4c blur-[200.00px] backdrop-opacity-[0.5]" ></div>
...
{[...Array(4)].map((d, index) => (
<AccountDropdownAccountFlashsell key={"listfive" + index} ></AccountDropdownAccountFlashsell>
))};
</Suspense>
</div>
</div>
