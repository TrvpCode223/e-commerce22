...
export default function CategorydropdownColumnOne() {
                        ...
                        <div className="flex flex-1 items-center md:flex-col md:self-stretch">
                            <div className="flex w-[30%] flex-col items-start gap-6 md:w-full">
                                <div className="flex items-center gap-4 self-stretch">
                                    <div className="h-[49px] w-[20px] rounded bg-orange-700" ></div>
                            ...
                            <div className="flex flex-1 items-center justify-center gap-4 px-[42px] md:self-stretch md:px-5">
                                ...
                                <div className="flex flex-1 flex-col items-start justify-center">
                                    ...
                                    <Heading
                                        size="headingxl"
                                        as="h2"
                                        className="!font-inter text-[32px] font-bold tracking-[1.28px] md:text-[300px] sm:text-[28px]"
                                    >
                                        56
                                    </Heading>
                                </div>
